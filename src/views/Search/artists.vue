...
const getSearchResult = async () => {
  ...
  try {
    ...
    hasMore.value = payload.hasMore || payload.artistCount > searchOffset.value + 50;
    searchCount.value = payload.artistCount || 0;
    const artistData = formatArtistsList(payload.artists || []);
